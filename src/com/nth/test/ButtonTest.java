...
import com.nth.JBootstrapFactory.JBootstrapButtonSize;
import com.nth.JBootstrapFactory.JBootstrapButtonType;
    ...
    public static void main(String... strings) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                btn.setIcon(new ImageIcon(getClass().getResource("/com/nth/swing/component1/test/dialog-information.png")));
