...
import com.nth.JBootstrapFactory;
import com.nth.JBootstrapFactory.JBootstrapBadgeType;
import com.nth.JBootstrapFactory.JBootstrapLabelType;
import com.nth.JBootstrapFactory.JBootstrapTextType;
import com.nth.JBootstrapLF;
    ...
    public static void main(String... strings) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                lbl.setIcon(new ImageIcon(getClass().getResource("/com/nth/swing/component1/test/dialog-information.png")));
                comp.add(lbl);
